...
export const calculatorDeclaration: FunctionDeclaration = {
  name: "calculator",
  description:
    "A simple calculator to perform basic arithmetic operations (add, subtract, multiply, divide). Use this when you need to calculate precise numbers, such as goal differences, expected goals totals, or win probabilities.",
  parameters: {
    type: Type.OBJECT,
    properties: {
      operation: {
