...
import type { HistoryResultCardModel } from './historyWorkspaceModel';

interface HistoryResultCardProps {
  model: HistoryResultCardModel;
  onOpen: (route: string, state: Record<string, unknown>) => void;
}

export function HistoryResultCard({ model, onOpen }: HistoryResultCardProps) {
  return (
