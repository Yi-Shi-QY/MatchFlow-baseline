...
import type { AnalysisDataStatusCardModel } from './analysisDataWorkspaceModel';

interface AnalysisDataStatusCardProps {
  model: AnalysisDataStatusCardModel;
}

export function AnalysisDataStatusCard({ model }: AnalysisDataStatusCardProps) {
  return (
