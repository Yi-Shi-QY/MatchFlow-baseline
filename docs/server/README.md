# Server Documentation / 服务端文档

## EN

## 1. Scope

This section is for Match Data Server 2.0 backend services, including:

1. API contracts and compatibility rules
2. auth, permissions, governance, and release flows
3. database, deployment, operations, and production gates
4. datasource collection, validation, and distribution lifecycle

## 2. Start Here

Recommended reading order for backend onboarding:
...
4. [22-server2-production-readiness-checklist.md](./22-server2-production-readiness-checklist.md)
...
4. [16-server-auth-and-admin-roadmap.md](./16-server-auth-and-admin-roadmap.md)
...
2. [14-extension-hub-spec.md](../14-extension-hub-spec.md)
...
本分区用于 Match Data Server 2.0 服务端文档，包含：
